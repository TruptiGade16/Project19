    ...
    <div class="container-fluid">
     ...
     <div class="row" style="height: 200px; padding-top: 70px; padding-bottom: 5px">
            ...
            <div class="col-5" style="border: solid 2px black; border-radius: 10px; ">
                    ...
                    <spr:form action="login.htm" commandName="org" style="font-weight: bold; margin-left: 80px;">
                        <table>
                        <tr> 
                            <td>UserName</td>
                            <td style="padding-bottom: 10px;"><spr:input path="userName" class="beauti" id="Fname" placeholder="Enter Name" style="padding-right: 100px;" /></td> 
                        </tr>

                        </p>
                        <tr>
                            <td>Password</td>
                            <td style="padding-bottom: 10px;"><spr:input path="password" type="password" class="beauti" id="Fname" placeholder="Enter Password" style="padding-right: 100px;"/></td>
                        </tr>
                        <tr>
                            <td ></td>
                            <td style="padding-bottom: 10px;padding-left: 30px">
                                ...
                                <input class="beauti" type="submit" value="SignUp" formaction="prep_OrgReg_form.htm" style="color: whitesmoke; border-radius: 7px; background-color: red; height: 35px; width: 100px;">
                            </td>
                        </tr>
                  </table>   
                 </spr:form>
