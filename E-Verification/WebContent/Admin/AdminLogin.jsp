                    ...
                    <form style="font-weight: bold; margin-left: 80px;">
                        ...
                        <tr>
                            ...
                            <td style="padding-bottom: 10px;padding-left: 30px">
                                <input class="beauti"  type="submit" value="Login" formaction="Admin.jsp" style="color: whitesmoke; border-radius: 7px; background-color: red; height: 35px; width: 100px;">
                                <input class="beauti" type="submit" value="SignUp" style="color: whitesmoke; border-radius: 7px; background-color: red; height: 35px; width: 100px;">
                            </td>
                        </tr>
                  </table>   
                    </form>
